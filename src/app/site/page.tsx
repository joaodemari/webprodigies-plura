...
export default function Home() {
  return (
    <>
      <section className="justify-cent36 relative mt-[-70px] flex h-full w-full flex-col items-center pt-36 md:pt-44">
        {/* grid */}
        ...
        <div className="relative bg-gradient-to-r from-primary to-secondary-foreground bg-clip-text text-transparent">
          <h1 className="text-center text-6xl font-bold md:text-[300px]">
            Plura
          </h1>
        </div>
